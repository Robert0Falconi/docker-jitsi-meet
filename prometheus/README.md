...
1. **Setup Jitsi with Docker Compose**
   ...
   Also, you could follow Self - Hosting guide of Rob Meet: [Jitsi handbook](https://jitsi.github.io/handbook/docs/devops-guide/devops-guide-docker/)
...
3. **Run Docker Compose**
   ...
   The following command turns up the Rob Meet:
